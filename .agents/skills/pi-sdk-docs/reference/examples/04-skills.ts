// Provenance
//   Upstream: https://github.com/badlogic/pi-mono/blob/main/packages/coding-agent/examples/sdk/04-skills.ts
//   Version:  0.58.4 (pinned in this repo's package.json)
//   Retrieved: 2026-03-17
//   Reason:   Skill discovery, filtering, and custom skills via DefaultResourceLoader
