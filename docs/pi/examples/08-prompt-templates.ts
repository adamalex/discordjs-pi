// Provenance
//   Upstream: https://github.com/badlogic/pi-mono/blob/main/packages/coding-agent/examples/sdk/08-prompt-templates.ts
//   Version:  0.58.4 (provisional — no pinned dependency in this repo yet)
//   Retrieved: 2026-03-17
//   Reason:   Slash commands / prompt templates from SDK
